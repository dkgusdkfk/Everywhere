            ...
            <div class="row">
                <div class="col-md-12 col-lg-8 w">
                    <div class="title-single-box">
                        <h1 class="title-single">{{ qna.title }}</h1>
                    </div>
                </div>
                ...
                <div class="post-information">
                    <ul class="list-inline text-center color-a d-flex justify-content-end" id="info">
                        <li class="list-inline-item mr-2">
                            <strong>작성자 : </strong>
                            <span class="color-text-a">{{ qna.userId }}</span>
                        </li>
                        <li class="list-inline-item mr-2">
                            <strong>작성일 : </strong>
                            <span class="color-text-a">{{ qna.registerTime }}</span>
                        </li>
                        <li class="list-inline-item">
                            <strong>조회 : </strong>
                            <span class="color-text-a">{{ qna.hit }}</span>
                        </li>
                        <li class="list-inline-item">
                            <strong>댓글 : </strong>
            ...
            <div class="row d-flex ">
                <div class="col-sm-12 d-flex flex-column align-content-center justify-content-center w-75">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <div v-if="userInfo != null && userInfo.id == qna.userId">
                            <b-button variant="outline-primary" size="sm" @click="moveModifyQna"
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="qnaId" value="${qna.qnaId}" name="qnaId">
...
export default {
    ...
    created() {
        ...
        http.get(`/qna/comment/${this.$route.params.qnaId}`).then(({ data }) => {
            this.comments = data;
        });
    },
    computed: {
    ...
    methods: {
        ...
        commentDelete(commentId) {
            if (confirm("정말로 삭제?")) {
                http.delete(`/qna/deleteComment/${commentId}`).then(({ data }) => {
